...
public abstract class CreateTombstone2<R extends ConnectRecord<R>> implements Transformation<R> {
  ...
  public static class Key<R extends ConnectRecord<R>> extends CreateTomb<R> {
  ...
  public static class Value<R extends ConnectRecord<R>> extends CreateTombstone2<R> {
