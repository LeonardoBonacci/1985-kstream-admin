...
public abstract class CreateTomb<R extends ConnectRecord<R>> implements Transformation<R> {
  ...
  public static class Value<R extends ConnectRecord<R>> extends CreateTomb<R> {
